        ...
        <td>
            <div class="dropdown table-action">
                ...
                <ul class="dropdown-menu">
                    @can('banners-update')
                        <li>
                            <a href="#edit-banner-modal" class="edit-banner-btn" data-bs-toggle="modal" data-url="{{ route('admin.banners.update', $banner->id) }}" data-image="{{ asset($banner->imageUrl) }}" data-status="{{ $banner->status }}">

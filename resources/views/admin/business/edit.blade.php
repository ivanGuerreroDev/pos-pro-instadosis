                        ...
                        <div class="add-suplier-modal-wrapper d-block">
                            <div class="row">
                                ...
                                <div class="col-lg-6 mb-2">
                                    ...
                                    <input type="email" name="email" value="{{ $user->email }}" required class="form-control" placeholder="{{ __('Enter Email') }}">
                                </div>
                        ...
                        <div class="add-suplier-modal-wrapper d-block">
                            <div class="row">
                                ...
                                <div class="col-lg-6 mb-2">
                                    ...
                                    <input type="text" name="dcoordEm" required class="form-control" value="{{ $business->invoice_data?->dcoordEm }}" placeholder="Ej: 8.983300,-79.516700">
                                </div>

                                <div class="col-lg-6 mb-2">
                                    <label>{{ __('Teléfono') }}</label>
                                    <input type="text" name="dtfnEm" required pattern="[0-9]{3,4}-[0-9]{4}" title="Formato requerido: 999-9999 o 9999-9999" class="form-control" value="{{ $business->invoice_data?->dtfnEm }}" placeholder="0000-0000" inputmode="numeric" autocomplete="off" maxlength="9">
                                </div>
